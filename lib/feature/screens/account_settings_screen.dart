...
class AccountSettingsView extends StatefulWidget {
  ...
  AccountSettingsView({super.key, this.myuser, this.callbackGetUserById});
...
Widget _card(Widget icon, String text, String whichUpdate, int userId,
        BuildContext context, void Function(int id)? callbackGetUserById) =>
    Card(
      color: Colors.black,
      child: ListTile(
        onTap: () {
              ...
              MaterialPageRoute(
                ...
                builder: (context) => Scaffold(
                    ...
                    body: UserDataUpdateView(
                      ...
                      userId: userId,
                      callbackGetUserById: callbackGetUserById,
                    )),
              ));
        },
